...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/19 10:51:59 by yaboumei          #+#    #+#             */
/*   Updated: 2025/12/19 10:52:02 by yaboumei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

static void	init_vars_v(t_game *g, double angle, double *step,
		double *intercept)
{
...
t_intersection	*verticaldist(t_game *g, double ray_angle)
{
	...
	inter->x = intercept[0];
	inter->y = intercept[1];
	inter->distance = distancebetwen2points(g->px, g->py, intercept[0],
			intercept[1]);
	return (inter);
}

static void	init_vars_h(t_game *g, double angle, double *step,
		double *intercept)
{
